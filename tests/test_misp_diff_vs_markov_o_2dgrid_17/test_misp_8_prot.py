...
def test_misp_2d():
    ...
    subprocess.call(['misp',  'o_nine.xyz',  'pbc', 'False', 'nowrap', 'O', '1', '1000', '100',  '100000', 'lmc.out', '10', '1', 'True', '--seed', '12341234', '--verbose', '--write_xyz'])
...
def test_misp_8prot_2d():
    ...
    subprocess.call(['misp',  'o_nine.xyz',  'pbc', 'False', 'nowrap', 'O', '8', '1000', '100',  '100000', 'lmc.out', '10', '1', 'True', '--seed', '12341234', '--verbose', '--write_xyz'])
