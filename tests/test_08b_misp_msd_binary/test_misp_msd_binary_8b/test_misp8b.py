...
def test_misp_8b():
    ...
    subprocess.call(['misp', 'o_n_sixteen_binary_chess.xyz', 'pbc', 'False', 'nowrap', 'O', 'N', '1', '1000', '100', '100000', 'lmc.out', '10', '1', 'True', '--seed', '12341234', '--verbose'])
    ...
    print(popt, pcov)
    #0.05778859 0.00143818
    #assert popt == pytest.approx(np.array([0.05778859, 0.00143818]),0.01 )
    assert popt == pytest.approx(np.array([0.05647172, 0.00446364]),0.01 )
